...
void assertInsert() 
{
    ...
    root = insertIntoTree(root, key1, (void *)value1, sizeof(int));
    ...
    root = insertIntoTree(root, key2, (void *)value2, sizeof(int));
    ...
    root = insertIntoTree(root, key3, (void *)value3, sizeof(int));
    ...
    for (int i = 3; i < 10; i++) 
    {
        root = insertIntoTree(root, keys[i], values[i], sizeof(int));
    }
